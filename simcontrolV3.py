...
class DroneSimulation(QThread):
    ...
    def create_label(self, object_handle, label_text, is_critical=False):
        try:
            ...
            # Set color parameter based on criticality
            color = [1, 0, 0] if is_critical else [0, 0, 0]  # Red for critical, Black for normal
    ...
    def create_coords(self, points):
        ...
        for key, data in points_copy.items():
            ...
            # Check if point is critical (c: True) and pass to create_label
